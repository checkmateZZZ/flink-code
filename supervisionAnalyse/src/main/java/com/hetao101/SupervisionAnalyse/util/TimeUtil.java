...
import com.hetao101.SupervisionAnalyse.common.DateEnum;
...
//    }
     ...
     * 根据指定时间戳返回默认格式的日期
     * */
    public static String parseLong2StringNew(Long time) {
     ...
     * 将时间戳转换成指定格式的日期
     * */
    public static String parseLong2StringNew(Long time, String pattern) {
