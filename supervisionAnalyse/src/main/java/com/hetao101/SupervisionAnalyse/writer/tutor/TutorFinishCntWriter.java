 ...
 * @date 2019/10/14
 */
public class TutorFinishCntWriter extends RichSinkFunction<Row> {
    private static Logger logger = Logger.getLogger(TutorFinishCntWriter.class);
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        writePs = writeConn.prepareStatement(
                "insert into htbc_app.app_supervision_course_tutor_user_detail_rt " +
                        ...
                        ",class_name,grade,class_type,term_id,term_name,counselor_id,counselor_name,course_level,unit_sequence,unit_unlocked_time,homework_unlock_cnt,challenge_unlock_cnt,total_unlock_cnt" +
                        ...
                        "is_finish_exam=if(is_finish_exam is not null and is_finish_exam=1,is_finish_exam,values(is_finish_exam))," +
                        "course_package_id=values(course_package_id);"
    ...
    public void invoke(Row value, Context context) {
        try {
            ...
            writePs.setString(13, (String) value.getField(12));
