...
public class UnlockCntWriter extends RichSinkFunction<ArrayList<MainPlotUser>> {
    ...
    //调用计算后的数据流
    @Override
    public void invoke(ArrayList<MainPlotUser> value, Context context) throws Exception {
        for (MainPlotUser mainPlotUser : value){
            ...
            writePs.setInt(10,mainPlotUser.getUnitId());
            writePs.setString(11,mainPlotUser.getUnitName());
            writePs.setInt(12,mainPlotUser.getUnitSequence());
            writePs.setString(13,mainPlotUser.getUnitUnlockedTime());
            writePs.setInt(14,mainPlotUser.getHomeworkOpenCnt());
            writePs.setInt(15,mainPlotUser.getChallengeOpenCnt());
            writePs.setInt(16,mainPlotUser.getTotalOpenCnt());
